//SANTIAGO EXEQUIEL FERNÁNDEZ - MAVI II, U2 - Ejercicio 6:
...
void Game::DoEvents()
{
    ...
    while (wnd->pollEvent(evt))
    {
        ...
        case Event::MouseButtonPressed:
            ...
            b2Body* body = Box2DHelper::CreateTriangularDynamicBody(phyWorld, b2Vec2(100.0f, 100.0f), 10.0f, 1.0f, 0.0f, 0.0f);
            ...
            body->SetTransform(b2Vec2(30.0f, 80.0f), 3.0f);
            break;
        }
    }
}
...
void Game::InitPhysics()
{
    ...
    phyWorld = new b2World(b2Vec2(20.0f, 15.0f));
    ...
    b2Body* bocaCanon = Box2DHelper::CreateRectangularStaticBody(phyWorld, 15, 10);
    bocaCanon->SetTransform(b2Vec2(17.5f, 80.0f), 0.0f);
}
