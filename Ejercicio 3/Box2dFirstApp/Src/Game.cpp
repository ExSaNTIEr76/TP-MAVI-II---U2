//SANTIAGO EXEQUIEL FERNÁNDEZ - MAVI II, U2 - Ejercicio 3:
...
void Game::DrawGame()
{
    ...
    obstacle1.setPosition(20, 40);
    wnd->draw(obstacle1);

    sf::RectangleShape obstacle2(sf::Vector2f(10, 10));
    obstacle2.setFillColor(sf::Color::Cyan);
    obstacle2.setPosition(70, 60);
    wnd->draw(obstacle2);
...
void Game::InitPhysics()
{
    ...
    phyWorld = new b2World(b2Vec2(10.0f, 40.0f));
    ...
    // Crear los obtáculos del mundo físico
    b2Body* obstacle1 = Box2DHelper::CreateRectangularStaticBody(phyWorld, 10, 10);
    obstacle1->SetTransform(b2Vec2(25.0f, 45.0f), 0.0f);

    b2Body* obstacle2 = Box2DHelper::CreateRectangularStaticBody(phyWorld, 10, 10);
    obstacle2->SetTransform(b2Vec2(75.0f, 65.0f), 0.0f);

    // Crear un círculo
    controlBody = Box2DHelper::CreateCircularDynamicBody(phyWorld, 5, 10.0f, 5.0, 4.0f);
    controlBody->SetTransform(b2Vec2(50.0f, 70.0f), 0.0f);
}
