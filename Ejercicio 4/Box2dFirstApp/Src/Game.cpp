//SANTIAGO EXEQUIEL FERNÁNDEZ - MAVI II, U2 - Ejercicio 4:
...
void Game::DoEvents()
{
    ...
    if (Keyboard::isKeyPressed(Keyboard::Left))
        controlBody->SetLinearVelocity(b2Vec2(-40.0f, 0.0f));
...
void Game::InitPhysics()
{
    ...
    phyWorld = new b2World(b2Vec2(1.0f, 40.0f));
    ...
    // Crear un bloque que se controlará con las flechas direccionales derecha e izquierda
